...
const Blog = () => {
    return (
            ...
            <section className=" body-font flex justify-center container-padding w-full ">
...
<div className="pt-5 flex gap-3">
       ...
       }} className="bg-white  text-black  transition-colors duration-300 ease-in-out hover:bg-primary hover:text-white  buttonStyle2  ">
           Travel
          </button>

             <button style={{
        border:"1px solid #eee"
       }} className="bg-white  text-black  buttonStyle2  ">
            Lifestyle
          </button>
</div>
                        ...
                        <div className="sm:w-1/2 mb-10 px-4 w-[50%]">
